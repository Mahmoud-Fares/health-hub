import { Trainer, Video } from '../types';

const sarahJohnson: Trainer = {
   name: 'Sarah Johnson',
   title: 'Certified Trainer',
   description:
      'Professional fitness instructor with over 10 years of experience helping people achieve their health goals.',
...
const mikeWilson: Trainer = {
   ...
   description:
      'Former Olympic athlete specializing in strength training and athletic performance.',
...
const emmaGarcia: Trainer = {
   ...
   description:
      'Certified yoga instructor and wellness coach focused on mindful movement and flexibility.',
...
export const videos: Video[] = [
   {
      ...
      description:
         'High-intensity interval training targeting all major muscle groups. Perfect for burning calories and building strength.',
      duration: 30,
      calories: 350,
   ...
   },
   {
      ...
      description:
         'Start your day with this energizing yoga flow that awakens your body and mind.',
      duration: 20,
      calories: 120,
      difficulty: 'Beginner',
   ...
   },
   {
      ...
      description:
         'Build serious upper body strength with this comprehensive workout targeting chest, back, and arms.',
      duration: 45,
      calories: 400,
      difficulty: 'Advanced',
   ...
   },
   {
      ...
      description:
         'Fun and energetic dance workout that gets your heart pumping while you learn new moves.',
      duration: 25,
      calories: 280,
      difficulty: 'Beginner',
      categories: ['Cardio', 'Dance', 'Fun'],
      thumbnailUrl:
         'https://images.pexels.com/photos/3768722/pexels-photo-3768722.jpeg?auto=compress&cs=tinysrgb&w=800',
      videoUrl:
   ...
   },
   {
      ...
      thumbnailUrl:
         'https://images.pexels.com/photos/3757987/pexels-photo-3757987.jpeg?auto=compress&cs=tinysrgb&w=800',
      videoUrl:
   ...
   },
   {
      ...
      description:
         'Relaxing stretching routine perfect for winding down and improving flexibility.',
      duration: 10,
      calories: 50,
      difficulty: 'Beginner',
   ...
   },
   {
      ...
      description:
         'Build powerful legs and glutes with this challenging lower body strength workout.',
      duration: 35,
      calories: 320,
      difficulty: 'Advanced',
   ...
   },
   {
      ...
      description:
         'High-intensity Tabata protocol for maximum calorie burn in minimal time.',
      duration: 20,
      calories: 300,
      difficulty: 'Advanced',
   ...
   },
   {
      ...
      description:
         'Classical Pilates exercises focusing on core stability and controlled movements.',
      duration: 40,
      calories: 250,
      difficulty: 'Intermediate',
   ...
   },
   {
      ...
      description:
         'Perfect introduction to strength training with basic movements and proper form guidance.',
      duration: 25,
      calories: 200,
      difficulty: 'Beginner',
