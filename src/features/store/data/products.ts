...
export const products: Product[] = [
   {
      ...
      rating: 4.7,
      reviewCount: 246,
      imageSrc: '../../img/61hlJBE612L._AC_UF894,1000_QL80_.jpg',
      description:
         'Advanced fitness tracker with GPS and heart rate monitoring.',
      features: [
         'Built-in GPS',
      ...
      specifications: [
         ...
         {
            name: 'Sensors',
            value: 'Heart rate, accelerometer, gyroscope, GPS',
         },
      ...
      reviews: [
         {
            ...
            comment:
               'The battery life is amazing and the heart rate monitor is very accurate!',
         },
         {
            id: 'r2',
            userName: 'JohnRunner',
            ...
            comment:
               'I use it for my daily runs and the GPS tracking is spot on.',
         },
      ],
      inStock: true,
      bestseller: true,
   },
   {
      ...
      rating: 4.8,
      reviewCount: 189,
      imageSrc: '../../img/Smart-watch-fits.webp',
      description:
         'Premium smartwatch with advanced health monitoring features.',
      features: [
         'ECG monitoring',
      ...
      specifications: [
         ...
         {
            name: 'Sensors',
            value: 'Heart rate, Pulse Ox, barometric altimeter, compass, gyroscope, accelerometer, thermometer',
         },
      ...
      reviews: [
         {
            ...
            comment:
               'The ECG and blood oxygen monitoring have been game changers for me.',
         },
         {
            id: 'r4',
            ...
            comment:
               'The battery life and durability are outstanding for hiking trips.',
         },
      ],
      inStock: true,
      new: true,
   ...
   },
   {
      ...
      rating: 4.6,
      reviewCount: 128,
      imageSrc: '../../img/download (3).jpeg',
      description:
         'High-precision smart scale with comprehensive body composition analysis.',
      features: [
         'Weight measurement',
         'Body fat percentage',
         'Muscle mass',
      ...
      reviews: [
         {
            ...
            comment:
               "Compared with my gym's professional scale and the readings match perfectly.",
         },
         {
            id: 'r8',
            ...
            comment:
               'The app integration makes it easy to track my body composition changes over time.',
         },
      ],
      inStock: true,
   },
   {
      ...
      rating: 4.9,
      reviewCount: 86,
      imageSrc: '../../img/download (4).jpeg',
      description:
         'Professional-grade heart rate monitor with maximum accuracy.',
      features: [
      ...
      reviews: [
         {
            ...
            comment:
               'As a professional athlete, I need reliable data and this delivers every time.',
         },
         {
            id: 'r10',
            ...
            comment:
               'The quick response time is essential for interval training.',
         },
      ],
      inStock: true,
   },
   {
      ...
      rating: 4.7,
      reviewCount: 42,
      imageSrc: '../../img/293569745223710.avif',
      description:
         'Interactive rowing machine with live and on-demand workouts.',
      features: [
         '22" HD touchscreen',
      ...
      specifications: [
         ...
         { name: 'Display', value: '22" 1080p HD' },
         {
            ...
            value: 'Computer-controlled electromagnetic',
         },
      ...
      reviews: [
         {
            ...
            comment:
               "The virtual classes make me forget I'm working out at home. Excellent machine!",
         },
         {
            id: 'r12',
            ...
            comment:
               'The resistance feels very natural. Great full-body workout.',
         },
      ],
      inStock: false,
   },
   {
      ...
      rating: 4.5,
      reviewCount: 73,
      imageSrc: '../../img/download (1).jpeg',
      description:
         'Rugged outdoor watch with advanced navigation and activity tracking.',
      features: [
         'Over 80 sport modes',
      ...
      specifications: [
         ...
         {
            name: 'Battery Life',
            value: 'Up to 30 days (time mode), 40 hours (GPS)',
         },
         { name: 'Water Resistance', value: '100m' },
         {
            name: 'Sensors',
            value: 'GPS, GLONASS, Galileo, heart rate, barometric altimeter, compass',
         },
      ...
      reviews: [
         {
            ...
            comment:
               'Took this to 14,000 feet and it performed flawlessly in freezing temperatures.',
         },
         {
            id: 'r14',
            ...
            comment:
               'The mapping and route tracking have saved me multiple times on long trail runs.',
         },
      ],
      inStock: true,
      new: true,
   },
   {
      ...
      rating: 4.2,
      reviewCount: 318,
      imageSrc: '../../img/download.jpeg',
      description:
         'Wireless earbuds designed specifically for intense workouts.',
      features: [
      ...
      reviews: [
         {
            ...
            comment:
               "Finally found earbuds that don't fall out when I'm doing burpees!",
         },
         {
            id: 'r16',
            ...
            comment:
               'The bass is impressive for such small earbuds. Perfect for my running playlists.',
         },
      ],
      inStock: true,
      bestseller: true,
